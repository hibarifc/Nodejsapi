...
exports.saveWork = function (users_id_service,users_id_ranter,drone_id,date,transaction_id,transaction_detail_id) {
    ...
    con.query(sql1, function (err, result) {
        ...
        con.query(sql,[users_id_service,users_id_ranter,drone_id,date,transaction_id,transaction_detail_id,workstatus_id,configid,users_id_service,datetime],function(err, result){
            if(err) throw err;
            console.log(err);
            con.end();
        });
